...
Cliente::Cliente(string nombre_r, string direccion_r, string fechaNacimiento_r, string folio_r, string fechaActual_r):Persona(nombre_r,direccion_r,fechaNacimiento_r)
{
    folio=folio_r;
    fechaActual=fechaActual_r;
}
